...
class DaKar{
    constructor(x,y,width,height){
        ...
        this.x=x;
        this.y=y;
        thctx.fillRect(  -this.width/2,  -this.height/2, this.width, this.height );
...
is.width=width;
    ...
    draw(ctx){ /*
        ...
        ctx.beginPath();
        ctx.fillStyle = 'brown';
        ctx.fillRect(  -this.width/2+2,  -this.height/2,  -this.width/2+4, this.height );
